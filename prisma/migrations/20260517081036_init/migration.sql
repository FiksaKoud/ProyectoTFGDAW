...
-- CreateIndex
CREATE INDEX "Supermarket_userId_idx" ON "Supermarket"("userId");

-- CreateIndex
CREATE INDEX "Product_userId_idx" ON "Product"("userId");

-- CreateIndex
CREATE INDEX "PriceRecord_productId_supermarketId_recorded_at_idx" ON "PriceRecord"("productId", "supermarketId", "recorded_at" DESC);
...
-- AddForeignKey
ALTER TABLE "Supermarket" ADD CONSTRAINT "Supermarket_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
